!function (c, M) {
    ...
    "use strict";
    var M, p = {}, n = {}, L = {}, q = {};
    o && "string" == typeof o.version || C("Moment Timezone requires Moment.js. See https://momentjs.com/timezone/docs/#/use-it/browser/");
    var c = o.version.split("."), z = +c[0], A = +c[1];
    ...
    function b(c) {
        var M = 0, z = c.split("."), A = z[0], b = z[1] || "", o = 1, p = 0, n = 1;
    ...
    function i(c) {
        var M = c.split("|"), z = M[2].split(" "), A = M[3].split(""), b = M[4].split(" ");
        return O(z), O(A), O(b), function (c, M) {
            for (var z = 0; z < M; z++) c[z] = Math.round((c[z - 1] || 0) + 6e4 * c[z]);
            c[M - 1] = 1 / 0
        }(b, A.length), {name: M[0], abbrs: N(M[1].split(" "), A), offsets: N(z, A), untils: b, population: 0 | M[5]}
    }
    ...
    function r() {
        ...
        var z, A, b, o = function () {
            ...
            for (M = 0; M < b; M++) for (z in A = q[c[M].offset] || {}) A.hasOwnProperty(z) && (o[z] = !0);
    ...
    function R(c) {
        var M = Array.prototype.slice.call(arguments, 0, -1), z = arguments[arguments.length - 1], A = u(z),
    ...
    (z < 2 || 2 === z && A < 6) && C("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + o.version + ". See momentjs.com"), W.prototype = {
        _set: function (c) {
            ...
            for (b = 0; b < a; b++) if (M = p[b], z = p[b + 1], A = p[b ? b - 1 : b], M < z && R.moveAmbiguousForward ? M = z : A < M && R.moveInvalidForward && (M = A), o < n[b] - 6e4 * M) return p[b];
            return p[a]
        }, abbr: function (c) {
    ...
    }, R.version = "0.5.21", R.dataVersion = "", R._zones = p, R._links = n, R._names = L, R.add = l, R.link = t, R.load = s, R.zone = u, R.zoneExists = function c(M) {
    ...
    o.tz = R, o.defaultZone = null, o.updateOffset = function (c, M) {
        ...
        if (c) {
            ...
            return this._z = u(c), this._z ? o.updateOffset(this, M) : C("Moment Timezone has no data for " + c + ". See http://momentjs.com/timezone/docs/#/data-loading/."), this
        }
